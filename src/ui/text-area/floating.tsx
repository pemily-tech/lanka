...
export function FloatingTextArea({
	...
	return (
		<div className="group relative">
			<label
				htmlFor={id}
				className={`origin-start text-16 text-muted-foreground/70 group-focus-within:text-12 group-focus-within:text-primary has-[+textarea:not(:placeholder-shown)]:text-foreground pointer-events-none absolute top-1/2 block -translate-y-1/2 cursor-text px-12 transition-all group-focus-within:pointer-events-none group-focus-within:top-0 group-focus-within:cursor-default group-focus-within:font-medium has-[+textarea:not(:placeholder-shown)]:pointer-events-none has-[+textarea:not(:placeholder-shown)]:top-0 has-[+textarea:not(:placeholder-shown)]:cursor-default has-[+textarea:not(:placeholder-shown)]:text-xs has-[+textarea:not(:placeholder-shown)]:font-medium ${
